...
export default function Allprojects() {
  ...
  function sendData(s){
    ...
    axios.post("http://localhost:8080/volunteer/save", newmember).then(()=>{

      alert("memebre join is successful",refreshPage());
      console.log(newmember);

    }).catch((err)=>{

      alert("Error: memebre not added");
      console.log(err);
  ...
  return (
    <div className="main-container">
        ...
        <div className="n4"><b>You want to be A Volunteer,</b></div>
        <div className="n5"><b>JOIN WITH US</b></div>
        ...
        <div className='projectName-container'>
              ...
              <input type="text"  id="contactNo" className="valuesV"   name="contactNo"  onChange={(event)=>{
              ...
              <input type="text" id="nic" className="valuesV" name="nic"  onChange={(event)=>{
                  setnic(event.target.value);
              }} required/>
              </div><br/>
              <input  type="submit" id="joinBtn"  value="Team Up"></input><br/><br/>
              <lable className="l1"><b>Click here to add you details.</b></lable><br/>
              <lable className="l2">Any requests please contact</lable><br/>
